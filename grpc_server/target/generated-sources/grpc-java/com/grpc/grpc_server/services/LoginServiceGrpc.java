...
public final class LoginServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpc.grpc_server.services.LoginServiceProto.LoginRequest,
      com.grpc.grpc_server.services.LoginServiceProto.LoginResponse> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Login",
      requestType = com.grpc.grpc_server.services.LoginServiceProto.LoginRequest.class,
      responseType = com.grpc.grpc_server.services.LoginServiceProto.LoginResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.grpc.grpc_server.services.LoginServiceProto.LoginRequest,
      com.grpc.grpc_server.services.LoginServiceProto.LoginResponse> getLoginMethod() {
    io.grpc.MethodDescriptor<com.grpc.grpc_server.services.LoginServiceProto.LoginRequest, com.grpc.grpc_server.services.LoginServiceProto.LoginResponse> getLoginMethod;
      ...
      synchronized (LoginServiceGrpc.class) {
        if ((getLoginMethod = LoginServiceGrpc.getLoginMethod) == null) {
          LoginServiceGrpc.getLoginMethod = getLoginMethod =
              io.grpc.MethodDescriptor.<com.grpc.grpc_server.services.LoginServiceProto.LoginRequest, com.grpc.grpc_server.services.LoginServiceProto.LoginResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.grpc_server.services.LoginServiceProto.LoginRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.grpc_server.services.LoginServiceProto.LoginResponse.getDefaultInstance()))
  ...
  public static abstract class LoginServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(com.grpc.grpc_server.services.LoginServiceProto.LoginRequest request,
        io.grpc.stub.StreamObserver<com.grpc.grpc_server.services.LoginServiceProto.LoginResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.grpc.grpc_server.services.LoginServiceProto.LoginRequest,
                com.grpc.grpc_server.services.LoginServiceProto.LoginResponse>(
                  this, METHODID_LOGIN)))
          .build();
    }
  }
  ...
  public static final class LoginServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LoginServiceBlockingStub> {
    ...
    /**
     */
    public com.grpc.grpc_server.services.LoginServiceProto.LoginResponse login(com.grpc.grpc_server.services.LoginServiceProto.LoginRequest request) {
  ...
  public static final class LoginServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LoginServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.grpc_server.services.LoginServiceProto.LoginResponse> login(
        com.grpc.grpc_server.services.LoginServiceProto.LoginRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((com.grpc.grpc_server.services.LoginServiceProto.LoginRequest) request,
              (io.grpc.stub.StreamObserver<com.grpc.grpc_server.services.LoginServiceProto.LoginResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class LoginServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.grpc_server.services.LoginServiceProto.getDescriptor();
    }
